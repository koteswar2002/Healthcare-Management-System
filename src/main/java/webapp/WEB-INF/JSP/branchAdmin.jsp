...
.banner_image {
	...
	background:
		url("https://media.istockphoto.com/id/1274428125/photo/healthcare-business-concept-medical-examination-and-growth-graph-data-of-business-on-tablet.jpg?b=1&s=170667a&w=0&k=20&c=dPwUh7zzvGwcyXqRRqZictkSAsNjqviHdRUAlEAwJw0=")
		no-repeat left;
...
<body>
	...
	<h2 id="txt"> Branch Admin Registration Form</h2>
	...
	<div id="formdiv">
		...
		<form:form action="saveBranchRegister" class="col-lg-6 offset-lg-3"
			modelAttribute="branchRegister">
			...
			<div class="form-group">
				<strong><label for="age">Gender:</label></strong>
				<div class="input-group">
					<span class="input-group-addon" id="gly"><i
						class="glyphicon glyphicon-user" style="color: white"></i></span>&nbsp;
					Male:
			...
			<div class="form-group">
				<strong><label for="age">Contact Number:</label></strong>
				<div class="input-group">
					<span class="input-group-addon" id="gly"><i
			...
			<%-- <div class="form-group">
				<strong><label for="age"> Branch Admin Id:</label></strong>
				<div class="input-group">
					<span class="input-group-addon" id="gly"><i
						class="glyphicon glyphicon-user" style="color: white"></i></span>
			 ...
			 <div class="form-group">
				<strong><label for="age">City:</label></strong>
				<div class="input-group">
					<span class="input-group-addon" id="gly"><i

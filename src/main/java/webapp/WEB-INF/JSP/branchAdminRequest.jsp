...
.banner_image {
	...
	background:
		url("https://img.freepik.com/free-vector/clean-medical-patterned-background_53876-116871.jpg?w=2000")
		no-repeat left;
...
<title>Branch Admin Request</title>
</head>
<body>
	...
	<h2 id="txt">Branch Admin Request Form</h2>
	<div id="formdiv">

		<!-- <div class="container-fluid p-5 col-9 my-3 bg-pink text-dark"> -->
		<!-- <h2 id="txt"><center>Registration Page</center></h2> -->

		<form:form action="saveBranchAdminRequest"
			class="col-lg-6 offset-lg-3" modelAttribute="branchAdminRequest">
			...
			<div class="form-group">
				<strong><label for="contactNumber">Contact Number:</label></strong>
				<div class="input-group">
					<span class="input-group-addon" id="gly"><i
